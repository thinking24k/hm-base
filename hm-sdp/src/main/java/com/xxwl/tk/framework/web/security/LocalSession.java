package com.xxwl.tk.framework.web.security;
...
import com.xxwl.tk.framework.domain.SessionUser;
...
public class LocalSession {
	...
	//没有集成shiro和redis暂时用原生session
	public static TerminalContext getCurrentTerminal(HttpSession session) {
		TerminalContext terminalContext = null;
		
		try {
			terminalContext = (TerminalContext)session.getAttribute(CommonAttribute.TERMINAL_CONTEXT);
