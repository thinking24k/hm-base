...
<div class="sidebar">
	<div class="sidebar-collapse">
		...
		<div class="sidebar-header">
			<img src="<c:url value="/js/lib/assets/img/logo.png"/>" class="img-responsive" alt="" />
		</div>
		<!-- Sidebar Menu-->
			...
			<nav id="menu" class="nav-main" role="navigation">
				<ul class="nav nav-sidebar">
					<div class="panel-body text-center">
						<div class="bk-avatar">
							<img src="<c:url value="/js/lib/assets/img/avatar.jpg"/>"
