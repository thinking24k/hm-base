...
<div class="navbar" role="navigation">
	<div class="container-fluid container-nav">
		...
		<ul class="nav navbar-nav navbar-actions navbar-left">
			<li class="visible-md visible-lg"><a href="table.html#"
				id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
			<li class="visible-xs visible-sm"><a href="table.html#"
				...
				<li><a href="#" class="dropdown-toggle notification-icon"
					...
					<ul class="dropdown-menu">
						...
						<li class="avatar"><a href="page-inbox.html"> <img
								class="avatar" src="<c:url value="/js/lib/assets/img/avatar1.jpg"/>" alt="" />
								<div>
						...
						<li class="avatar"><a href="page-inbox.html"> <img
								class="avatar" src="<c:url value="/js/lib/assets/img/avatar2.jpg"/>" alt="" />
								<div>
									<div class="point point-primary point-lg"></div>
									New message
						...
						<li class="avatar"><a href="page-inbox.html"> <img
								class="avatar" src="<c:url value="/js/lib/assets/img/avatar3.jpg"/>" alt="" />
								<div>
									<div class="point point-primary point-lg"></div>
									New message
						...
						<li class="avatar"><a href="page-inbox.html"> <img
								class="avatar" src="<c:url value="/js/lib/assets/img/avatar4.jpg"/>" alt="" />
								<div>
									<div class="point point-primary point-lg"></div>
									New message
						...
						<li class="avatar"><a href="page-inbox.html"> <img
								class="avatar" src="<c:url value="/js/lib/assets/img/avatar5.jpg"/>" alt="" />
								<div>
									<div class="point point-primary point-lg"></div>
									New message
			...
			<div class="userbox">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					<div class="profile-info">
						<span class="name">张三</span> <span class="role">管理员</span>
